...
Story.delete_all
User.delete_all
rosen_user = User.create(name: "Rosenroot", email: "Rosenroot@rosenroot.by", avatar: File.new("/home/kakacut/Desktop/anis.jpg"), password: "rosenroot", password_confirmation: "rosenroot")
dick_user = User.create(name: "Dick", email: "Dick@dick.by", avatar: File.new("/home/kakacut/Desktop/teemo.jpg"), password: "dickdick", password_confirmation: "dickdick")
